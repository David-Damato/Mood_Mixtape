...
export default function Questions(){
    ...
    return(
        <div className="questionsFramed">
            ...
            <div className={replyOneAppears ? "reply-appears" : "reply-hidden"}><p>Créée en 2021, <em className="moodMixtape">Mood Mixtape</em> est une application qui vous permet de choisir une playlist en accord avec votre humeur.</p>
            ...
            <div className={replyTwoAppears ? "reply-appears" : "reply-hidden"}>Oui, bien sûr. Il suffit de vous rendre sur l'onglet « Playlists » du menu. Nous vous avons même préparé une playlist bonus ! </div>
